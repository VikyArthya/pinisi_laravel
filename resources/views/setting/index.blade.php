            ...
            <form action="{{ route('setting.update') }}" method="post" class="form-setting" data-toggle="validator" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" readonly value="Pinisi Official" name="nama_perusahaan" class="form-control" id="nama_perusahaan" required autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-2">
                            <select name="tipe_nota" readonly value="Nota Kecil" class="form-control" id="tipe_nota" required>
